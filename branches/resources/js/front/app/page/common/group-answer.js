/*-----------------------------------------------------------------------------
* @Description:     前台套题测试查看答案页面操作公共部分
* @Version:         1.0.0
...
*     前台套题测试查看答案页面操作公共部分
* --------------------------------------------------------------------------*/
KISSY.add('page/common/group-answer',function(S,ExamManage,error,click,index){
	PW.namespace('page.common.GroupAnswer');
	PW.page.common.GroupAnswer = function(param, IO){
	...
	requires:['groupExamAnswer/getAndNum','groupExamAnswer/error','groupExamAnswer/click','groupExamAnswer/index']
});
/*--------------------------------获取题目------------------------------*/
KISSY.add('groupExamAnswer/getAndNum',function(S,Juicer){
	var
...
/*--------------------------------退出------------------------------*/
KISSY.add('groupExamAnswer/error',function(S){
	var
	...
	S.augment(exit,{
		...
		_openErrorDialog:function(){
			var
				...
				tip = '<form class="J_errorForm"><textarea name="description" class="error-text"></textarea><input name="index" type="hidden" value="'+questionIndex+'"></form>',
	    		btnTest = '提交纠错';
...
/*--------------------------------点击非白色地方报错------------------------------*/
KISSY.add('groupExamAnswer/click',function(S){
	var
...
/*********************将页面导航页面操作加入到页面****************************/
KISSY.add('groupExamAnswer/index',function(S){
	function index(){
		this._init();
	}
	S.augment(index,{
