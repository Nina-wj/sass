...
*     首页操作
* --------------------------------------------------------------------------*/
KISSY.add('page/study/correct-question',function(S,correctQuestion){
	PW.namespace('page.study.correctQuestion');
	PW.page.study.correctQuestion = function(){
		return new correctQuestion();
	}
},{
	requires:['correctQuestion/search']
});
KISSY.add('correctQuestion/search',function(S){
    var
    ...
    function correctQuestion(param){
        this.opts = param;
        this._pagination;
        this.init();
    };
    S.augment(correctQuestion,{
        init:function(){
        ...
        _getPagination: function(){
            var
                ...
                url,
                data;                    
            setPagingConn = setPaging.getCorrectGroupBookPagination;
